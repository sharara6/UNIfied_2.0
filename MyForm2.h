...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Size = System::Drawing::Size(366, 39);
			this->label1->TabIndex = 2;
			this->label1->Text = L"Sign in as a Registerar";
			// 
			// button1
			// 
			this->button1->BackColor = System::Drawing::Color::Cyan;
			this->button1->Cursor = System::Windows::Forms::Cursors::Hand;
			this->button1->Location = System::Drawing::Point(907, 549);
			...
			this->Exitb1->Location = System::Drawing::Point(1048, 549);
			this->Exitb1->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->Exitb1->Name = L"Exitb1";
			this->Exitb1->Size = System::Drawing::Size(136, 43);
			this->Exitb1->TabIndex = 16;
			this->Exitb1->Text = L"Exit";
			this->Exitb1->UseVisualStyleBackColor = false;
			this->Exitb1->Click += gcnew System::EventHandler(this, &MyForm2::Exitb1_Click);
			// 
			// SignInb
			// 
			...
			this->SignInb->Location = System::Drawing::Point(463, 449);
			this->SignInb->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->SignInb->Name = L"SignInb";
			this->SignInb->Size = System::Drawing::Size(136, 43);
			this->SignInb->TabIndex = 15;
			this->SignInb->Text = L"Sign in";
			this->SignInb->UseVisualStyleBackColor = false;
			this->SignInb->Click += gcnew System::EventHandler(this, &MyForm2::SignInb_Click);
			// 
			// Password
			// 
			this->Password->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10.8F));
			this->Password->Location = System::Drawing::Point(207, 372);
			...
			this->label3->Location = System::Drawing::Point(203, 348);
			...
			this->ID->Location = System::Drawing::Point(207, 224);
			...
			this->checkBox1->Location = System::Drawing::Point(206, 405);
...
private: System::Void SignInb_Click(System::Object^ sender, System::EventArgs^ e) {
	MyForm4^ adm = gcnew MyForm4;


	if (ID->Text == "admin") {
		if (Password->Text == "ad@ZC-2456") {
			adm->Show();
			this->Close();
		}
		else {
		...
		MessageBox::Show("Incorrect Password and ID", "Error", MessageBoxButtons::OK, MessageBoxIcon::Error);
